...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var arrayResult = arraySamples.filter(selectedSample => selectedSample.id == sample);
    ...
    var sampleValuesOtu = sampleResult.sample_values;
    ...
    var mdArray = sampleMetadata.filter(sampleData => sampleData.id == sample);
